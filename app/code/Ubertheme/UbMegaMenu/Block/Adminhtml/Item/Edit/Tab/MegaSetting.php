...
class MegaSetting extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'mega_col_width',
                'label' => __('Submenu Column Width (px)'),
                'title' => __('Submenu Column Width (px)'),
                'required' => false,
                'class' => 'validate-number',
                'note' => __("Default value is 200px. Set to 0 or leave blank to use the default value."),
                'disabled' => $isElementDisabled
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('Grid Column Submenu (px)'),
                'title' => __('Grid Column Submenu (px)'),
                'note' => __("<span style=\"color:red;\">This field will override Submenu Column Width above</span>. You can create submenus with different width columns. Example Setting(px):<br/>col1=200<br/>col2=250"),
                'required' => false,
                'disabled' => $isElementDisabled
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'mega_width',
                'label' => __('Wrapper Width (px)'),
                'title' => __('Wrapper Width (px)'),
                'required' => false,
                'class' => 'validate-number',
                'note' => __("Define the container (px) of all submenu columns. Set to 0 or leave blank to use auto width."),
                'disabled' => $isElementDisabled
            ]
        );
