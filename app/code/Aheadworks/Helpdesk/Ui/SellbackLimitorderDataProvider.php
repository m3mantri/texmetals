...
/**
 * Class SellbackLimitorderDataProvider
 * @package Aheadworks\Helpdesk\Ui
 */
class SellbackLimitorderDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
     * Collection factory
    ...
    private function addPermissionFilters()
    {
        ...
        $this->getCollection()
            ...
            ->addFieldToFilter('category', 'sellback-limitorder');
