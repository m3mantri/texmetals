...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /* custom CP - Add Category Column */
        if ($context->getVersion() && version_compare($context->getVersion(), '1.2.1', '<')) {
            $this->addCategoryColumn($setup);
        }
    }
     ...
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
    private function addCategoryColumn(SchemaSetupInterface $setup)
    {
        // Get module table
