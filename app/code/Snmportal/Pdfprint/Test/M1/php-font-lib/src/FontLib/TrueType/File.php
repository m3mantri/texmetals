...
namespace Snmportal\External\FontLib\TrueType;

use Snmportal\External\FontLib\AdobeFontMetrics;
use Snmportal\External\FontLib\Font;
use Snmportal\External\FontLib\BinaryStream;
use Snmportal\External\FontLib\Table\Table;
use Snmportal\External\FontLib\Table\DirectoryEntry;
use Snmportal\External\FontLib\Table\Type\glyf;
use Snmportal\External\FontLib\Table\Type\name;
use Snmportal\External\FontLib\Table\Type\nameRecord;
...
class File extends BinaryStream {
  ...
  function parseTableEntries() {
    ...
    $class = "\\Snmportal\\External\\FontLib\\$type\\TableDirectoryEntry";
  ...
  protected function readTable($tag) {
    ...
    if (!self::$raw) {
      ...
      $class = "\\Snmportal\\External\\FontLib\\Table\\Type\\$name_canon";
      ...
      $class = "\\Snmportal\\External\\FontLib\\Table\\Table";
    }
