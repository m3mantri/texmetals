 ...
 */
//AUIT
namespace Snmportal\External\Dompdf\lib;
...
class Cpdf
{
    ...
    public $stringSubsetsText = array();
    /**
...
//AUIT        echo $tmp;
    ...
    function registerText($font, $text)
    {
        ...
        if (!isset($this->stringSubsets[$font])) {
            ...
            //AUIT
            $this->stringSubsetsText[$font] = array();
        }
...
//AUIT                    print 'trouble writing file from GD';
    ...
    {
        $doc = new \Snmportal\External\Svg\Document(); //AUIT
        $doc->loadFile($file);
        ...
        $surface = new \Snmportal\External\Svg\Surface\SurfaceCpdf($doc, $this);//AUIT
        $doc->render($surface);
