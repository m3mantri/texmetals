...
class Options
{
     ...
     * @see Snmportal\External\Dompdf\Adapter\CPDF::PAPER_SIZES for valid sizes
     *
     * @var string
     */
     ...
     * CPDF. 'GD' renders PDFs to graphic files. {@link Snmportal\External\Dompdf\CanvasFactory}
