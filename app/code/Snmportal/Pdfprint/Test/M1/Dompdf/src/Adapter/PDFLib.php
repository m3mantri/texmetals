...
namespace Snmportal\External\Dompdf\Adapter;

use Snmportal\External\Dompdf\Canvas;
use Snmportal\External\Dompdf\Dompdf;
use Snmportal\External\Dompdf\Helpers;
use Snmportal\External\Dompdf\Exception;
use Snmportal\External\Dompdf\FontMetrics;
use Snmportal\External\Dompdf\Image\Cache;
use Snmportal\External\Dompdf\PhpEvaluator;

/**
 * PDF rendering interface
 *
 * Snmportal\External\Dompdf\Adapter\PDFLib provides a simple, stateless interface to the one
 * provided by PDFLib.
 *
...
class PDFLib implements Canvas
{
     ...
     * @var array;
     */
    static public $PAPER_SIZES = array(); // Set to Snmportal\External\Dompdf\Adapter\CPDF::$PAPER_SIZES below.
     ...
     * Class constructor
     *
     * @param mixed $paper The size of paper to use either a string (see {@link Snmportal\External\Dompdf\Adapter\CPDF::$PAPER_SIZES}) or
