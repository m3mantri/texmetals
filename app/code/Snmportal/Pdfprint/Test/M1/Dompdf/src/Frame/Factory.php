...
use Snmportal\External\Dompdf\FrameDecorator\AbstractFrameDecorator;
use DOMXPath;
use Snmportal\External\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use Snmportal\External\Dompdf\FrameReflower\Page as PageFrameReflower;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $positioner = "Snmportal\\External\\Dompdf\\Positioner\\$positioner";
        $decorator = "Snmportal\\External\\Dompdf\\FrameDecorator\\$decorator";
        $reflower = "Snmportal\\External\\Dompdf\\FrameReflower\\$reflower";
