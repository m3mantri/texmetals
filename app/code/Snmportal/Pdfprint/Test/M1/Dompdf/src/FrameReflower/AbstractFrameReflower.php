 ...
 */
namespace Snmportal\External\Dompdf\FrameReflower;
...
use Snmportal\External\Dompdf\FrameDecorator\Block;
...
abstract class AbstractFrameReflower
{
    ...
    protected function _parse_string($string, $single_trim = false)
    {
        ...
        $string = preg_replace_callback("/\\\\([0-9a-fA-F]{0,6})/",
            function ($matches) {
                return \Snmportal\External\Dompdf\Helpers::unichr(hexdec($matches[1]));
            },
            $string);
        return $string;
    }
