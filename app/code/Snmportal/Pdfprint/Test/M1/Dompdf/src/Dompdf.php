...
use DOMDocument;
use DOMNode;
use Snmportal\External\Dompdf\Adapter\CPDF;
use DOMXPath;
use Snmportal\External\Dompdf\Frame;
use Snmportal\External\Dompdf\Frame\Factory;
use Snmportal\External\Dompdf\Frame\FrameTree;

//use Snmportal\External\Dompdf\HTML5_Tokenizer;
//use Snmportal\External\Dompdf\HTML5_TreeBuilder;
use Snmportal\External\Dompdf\Image\Cache;
use Snmportal\External\Dompdf\Renderer\ListBullet;
use Snmportal\External\Dompdf\Renderer;
use Snmportal\External\Dompdf\Css\Stylesheet;
 ...
 * the {@link Snmportal\External\Dompdf\Adapter\CPDF} class provides a simple, stateless interface to
 * PDF generation.)  PDFLib support has now also been added, via the {@link
 * Snmportal\External\Dompdf\Adapter\PDFLib}.
 *
 *
 * @package dompdf
 */
class Dompdf
{
    ...
    */
    ...
    public function loadHtml($str, $encoding = null)
    {
        ...
        set_error_handler(array('\Snmportal\External\Dompdf\Helpers', "record_warnings"));
     ...
     *
     * @param string $size 'letter', 'legal', 'A4', etc. {@link Snmportal\External\Dompdf\Adapter\CPDF::$PAPER_SIZES}
    ...
    /**
     * Return the underlying Canvas instance (e.g. Snmportal\External\Dompdf\Adapter\CPDF, Snmportal\External\Dompdf\Adapter\GD)
     *
     * @return Canvas
     */
